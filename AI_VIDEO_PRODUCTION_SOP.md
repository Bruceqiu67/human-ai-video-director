...
- **声音系统**：
  - 单人口播旁白，统一且仅使用微软高品质音色 **`zh-CN-YunjianNeural`**（纯单人导师讲述感，禁止销售与客户对答的多角色机器感）；
  - 语速设置：标准语速提速 ~15%~20% (`atempo=1.15~1.20`)，咬字干脆利落。
...
- **台词配音** (zh-CN-YunjianNeural 原生恒定稳健语速 rate=+20%, 0% atempo，单句保留 0.3s~0.4s 自然气口)：
  > “一通练完，AI立刻输出深度体检单！第一次只有45分？别慌，它给的可不是泛泛的加油，而是指骨到肉的解法：开场白太冗长？直接教你‘利益前置’——第一句话抛出‘为您预留了800元续保补贴’，一秒锁死客户注意力！”
- **动效落地**：
